...
let countedIpTable: { ip: string, count: number, time: Date, allCount: number }[] = [];
...
const inMemoryLimits = new Map<string, Counter>();
...
const checkDomainMiddleware = async (c: any, next: () => Promise<void>) => {
